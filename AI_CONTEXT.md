...
- S00、T01-A/B/C/D-A/D-B/D-C 和 T02-A/B/C 已完成；T03-P4-L 已完整关闭，T03-P1-BIAS 与 T03-P1-CAP-RATIO 共同关闭数值 P1。T03-P2-DIT 界面子阶段已关闭；bulk-trap 的 30/30 静态合同、三案例方程冒烟运行器和独立落盘检查已通过（E2/E3）。正式 V1 完成 8/328/248 但保持 E0/FAIL；V2 合同 23/23 E3 静态 PASS 后完成 8 器件/440 次收敛 DC/360 点，但最高 NTA 的 `VTH+0.2 V=1.6666676 V` 缺少中心差分上邻点，故 V2 也保持 E0/FAIL。两次失败完整保留，V2 独立检查未运行；完整 P2 仍为 partial，阶段暂停等待恢复决定。G0 仍为 `TEACHING_BASELINE_ONLY`；P3/P5、M00/C00/L00/V01 仍未实现。
- HZO 是可选扩展，不能阻塞基础闭环。
...
8. T02-A/B/C、T03-P4-L、完整数值 P1、T03-P2-DIT 界面子阶段和 T03-P2-BULK-TRAPS 方程冒烟已通过；正式 V1/V2 失败均已保留。当前必须暂停并等待恢复决定；不得直接补点、运行 V2 独立检查或铺开 P3/P5、M00/M01、SPICE、电路、KLayout、PEX 或 HZO。
