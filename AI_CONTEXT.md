...
- S00 数据审计及 T01-A/B/C/D-A/D-B 已完成，G0 为 `TEACHING_BASELINE_ONLY`；T01-D-B 已完成冻结的离散 Id-Vd 曲线族并打开 T01-D-C，T01-D-C、M00/C00/L00/V01 仍未实现。
- HZO 是可选扩展，不能阻塞基础闭环。
...
8. 用户已授权并完成 T01-D-B。下一步只能以通过的 interface_4x 网格和冻结偏压口径进入 T01-D-C，补齐状态图、受限参数提取并关闭完整 T01。未经新指令不得启动 T02、SPICE、KLayout 或大批量扫描。
