...
8. T02-A/B/C、T03-P1/P2/P3/P4/P5、M00 R02 两级数值门和 M01 revision-3 静态合同已完成，历史失败继续保留。M00 R01、R02 和 M01 R01 预检均不得重跑；不得放宽阈值、改变 split 或用 holdout 调参。下一步只建立并提交开源第二路线恢复合同；合同前不得传入器件网表。M01 数值执行、电路、KLayout、PEX 和 HZO 继续关闭。
