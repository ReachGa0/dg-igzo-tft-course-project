...
- S00、T01-A/B/C/D-A/D-B/D-C 和 T02-A/B/C 已完成；T03-P4-L 已完整关闭，T03-P1-BIAS 与 T03-P1-CAP-RATIO 共同关闭数值 P1。T03-P2-DIT 界面子阶段已关闭；bulk-trap 的 30/30 静态合同、三案例方程冒烟运行器和独立落盘检查已通过（E2/E3）。正式 V1 的 8/328/248 与 V2 的 8/440/360 均为 E0/FAIL 且完整保留。用户批准的 V3 只统一把栅压上限扩展到 1.8 V；24/24 E3 静态合同冻结 8 器件、456 次计划 DC 和 376 个计划点，尚未运行。完整 P2 仍为 partial，下一门仅为 V3 正式运行。G0 仍为 `TEACHING_BASELINE_ONLY`；P3/P5、M00/C00/L00/V01 仍未实现。
- HZO 是可选扩展，不能阻塞基础闭环。
...
8. T02-A/B/C、T03-P4-L、完整数值 P1、T03-P2-DIT 界面子阶段和 T03-P2-BULK-TRAPS 方程冒烟已通过；正式 V1/V2 失败均已保留，V3 合同已通过。当前只允许运行一次完整 V3，且只有运行器 PASS 后才运行独立检查；不得铺开 P3/P5、M00/M01、SPICE、电路、KLayout、PEX 或 HZO。
