...
- S00、T01-A/B/C/D-A/D-B/D-C 和 T02-A 顶栅极限回归已完成，G0 为 `TEACHING_BASELINE_ONLY`；T02-A 只打开最小非零双栅偏压族，T02 完整耦合、M00/C00/L00/V01 仍未实现。
- HZO 是可选扩展，不能阻塞基础闭环。
...
8. T02-A 合同与极限回归已通过。下一步只能运行 T02-B 的最小非零顶栅偏压族，同时固定底栅、VDS、几何、缺陷、接触和温度；通过前不得启动完整双向扫描、T03、SPICE、KLayout 或大批量扫描。
