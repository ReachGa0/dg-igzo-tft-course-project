...
- S00、T01-A/B/C/D-A/D-B/D-C 和 T02-A/B/C 已完成；T03-P4-L 已完成，G0 仍为 `TEACHING_BASELINE_ONLY`。冻结教学模型的完整 T01/T02 数值门已关闭，T03 仅完成 P4-L，P1/P2/P3/P5、M00/C00/L00/V01 仍未实现。
- HZO 是可选扩展，不能阻塞基础闭环。
...
8. T02-A/B/C 已通过，T03-P4-L 已完成。下一步只能为 P1/P2/P3/P5 中一个组冻结新的最小单变量敏感性合同，至少三个点且保持共同提取口径不变；合同通过后只运行这一组。不得同时铺开剩余四组扫描，也不得提前启动 SPICE、KLayout 或 HZO。
