...
8. T02-A/B/C、T03-P1/P2/P3/P4/P5、M00 R02 两级数值门和 M01 revision-3/开源恢复/R05 静态合同已完成，历史失败继续保留。M00 R01/R02、M01 Xyce build/tool R01/R02/R03/R04/R05 和 R05 静态合同均不得重跑；不得放宽阈值、改变 split 或用 holdout 调参。先提交 R05 19/29 失败，再建立 R06 合同；R06 两级门前不得传入正式器件网表。M01 数值执行、电路、KLayout、PEX 和 HZO 继续关闭。
