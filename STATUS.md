...
- 排版与精简版：最终报告外壳已修正目录重复编号、长表格断词/窄屏滚动和图表分页规则；自包含 `report/final/项目精简报告.html` 与 PDF 已改为连续紧凑排版（打印 14 页），保留器件方法、T01/T02、五组 T03、M00/M01、C00 R04 负结果、复现信息和边界，适合作为课程报告主读本；不替代完整审计报告或新增任何实验结论。
