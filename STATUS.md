...
- 下一步：提交并推送 R08 30/36 checker 注册失败归档；随后建立并提交 R09 新合同，唯一运行 R09 36 项静态门。R08/R07 及其 runner/独立检查不重跑，正式 M01 器件 DC 和下游继续关闭。
