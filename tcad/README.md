...
## 后续 T01-D-B/C 与 T02 必须增加什么

1. 冻结多 VGS `Id-Vd` 曲线并检查收敛、端口守恒和输出趋势；
2. 补齐关态、阈值附近和开态的电势、电子浓度与电流密度；
3. 在教学边界内提取 VTH/SS/迁移率并明确适用域；
4. T02 再加入顶栅移动电荷与上下栅耦合；
5. 后续受控加入带尾态、深能级、界面陷阱和非理想接触；
