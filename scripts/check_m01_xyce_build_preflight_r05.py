#!/usr/bin/env python3
"""Independently check persisted revision-5 Xyce preflight evidence."""
...
implementation.CONFIG_PATH = ROOT / "config" / "m01_xyce_build_preflight_r05.json"
implementation.RUNNER_PATH = ROOT / "scripts" / "run_m01_xyce_build_preflight_r05.py"
implementation.REPORT_PATH = ROOT / "results" / "reports" / "m01_xyce_build_preflight_r05.json"
implementation.CHECK_REPORT_PATH = ROOT / "results" / "reports" / "m01_xyce_build_preflight_check_r05.json"
...
R05_INDEPENDENT_CHECK_COUNT = 20
