#!/usr/bin/env python3
"""Run the revision-4 Xyce preflight with explicit user-local BLAS/LAPACK paths."""
...
R04_STATIC_BOUNDARY_MARKER = "formal_device_dc_invoked=false"
...
def add_check(checks: list[dict[str, str]], name: str, passed: bool, detail: str) -> None:
    if name == "identity:revision_1_xyce_build_preflight":
        name = "identity:revision_4_xyce_build_preflight"
        passed = (
