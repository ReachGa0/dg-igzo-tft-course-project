#!/usr/bin/env python3
"""Run the formal C00 R03 ngspice/Xyce inverter analyses exactly once."""
...
CONTRACT_CHECKER_PATH = ROOT / "scripts" / "check_c00_active_load_inverter_r03_contract.py"
...
def run() -> int:
    ...
    print(f"C00_ACTIVE_LOAD_INVERTER_R03_{status} checks={passed}/{EXPECTED_CHECK_COUNT} report={report_path}")
