...
CONTRACT_CHECKER_PATH = ROOT / "scripts" / "check_m01_open_source_device_dc_r02_contract.py"
...
def run() -> int:
    ...
    print(
        f"M01_OPEN_SOURCE_DEVICE_DC_R02_{status} checks={passed}/{EXPECTED_CHECK_COUNT} "
