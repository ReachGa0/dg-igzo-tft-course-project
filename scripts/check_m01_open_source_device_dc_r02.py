#!/usr/bin/env python3
"""Independently recompute persisted M01 R02 two-route device DC evidence."""
...
from m01_open_source_device_dc_r02_common import (
    DIFFERENCE_FIELDS,
    METRIC_FIELDS,
    RAW_FIELDS,
    compute_metrics,
...
RUN_REPORT_PATH = ROOT / "results" / "reports" / "m01_open_source_cross_check_r02.json"
CHECK_REPORT_PATH = ROOT / "results" / "reports" / "m01_open_source_cross_check_r02_check.json"
...
def check() -> int:
    ...
    machine = experiment_map["M01"]["open_source_device_dc_r02"]
    ...
    expected_xy = [
        ...
        outputs["xyce_log"],
        "-o",
        "results/compact/m01_open_source_cross_check_r02/xyce_values",
    ...
    print(
        f"M01_OPEN_SOURCE_DEVICE_DC_R02_CHECK_{status} checks={passed}/{EXPECTED_CHECK_COUNT} "
