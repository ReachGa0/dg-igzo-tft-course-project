#!/usr/bin/env python3
"""Shared deterministic helpers for the M01 route-divergence R01 probe."""
...
def portable_candidate_text(candidate_text: str) -> str:
    ...
    text = candidate_text.replace(
        "IGZO_DG_BEHAVIORAL_R02", "IGZO_DG_PORTABLE_PROBE_R01"
    )
...
def generate_probe_netlist(
    ...
    lines = [
        f"* M01 route-divergence root-cause R01 {route}",
