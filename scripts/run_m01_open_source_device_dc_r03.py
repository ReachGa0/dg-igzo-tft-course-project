...
CONTRACT_CHECKER_PATH = ROOT / "scripts" / "check_m01_open_source_device_dc_r03_contract.py"
...
def run() -> int:
    ...
    try:
        ...
        committed_static_pass = (
            ...
            and machine.get("contract_checks_passed") == 42
        ...
        r11_check_status = {
            ...
            for item in r11_check.get("checks", [])
        }
        r11_ok = (
    ...
    print(
        f"M01_OPEN_SOURCE_DEVICE_DC_R03_{status} checks={passed}/{EXPECTED_CHECK_COUNT} "
