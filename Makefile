...
m01-xyce-build-preflight-r06-contract-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r06_contract.py

m01-xyce-build-preflight-r06:
	"$(PYTHON)" scripts/run_m01_xyce_build_preflight_r06.py

m01-xyce-build-preflight-r06-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r06.py

m01-xyce-build-preflight-r07-contract-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r07_contract.py

m01-xyce-build-preflight-r07:
	"$(PYTHON)" scripts/run_m01_xyce_build_preflight_r07.py

m01-xyce-build-preflight-r07-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r07.py

m01-xyce-build-preflight-r08-contract-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r08_contract.py

m01-xyce-build-preflight-r08:
	"$(PYTHON)" scripts/run_m01_xyce_build_preflight_r08.py

m01-xyce-build-preflight-r08-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r08.py

m01-xyce-build-preflight-r09-contract-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r09_contract.py

m01-xyce-build-preflight-r09:
	"$(PYTHON)" scripts/run_m01_xyce_build_preflight_r09.py

m01-xyce-build-preflight-r09-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r09.py

m01-xyce-build-preflight-r10-contract-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r10_contract.py

m01-xyce-build-preflight-r10:
	"$(PYTHON)" scripts/run_m01_xyce_build_preflight_r10.py

m01-xyce-build-preflight-r10-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r10.py

m01-xyce-build-preflight-r11-contract-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r11_contract.py

m01-xyce-build-preflight-r11:
	"$(PYTHON)" scripts/run_m01_xyce_build_preflight_r11.py

m01-xyce-build-preflight-r11-check:
	"$(PYTHON)" scripts/check_m01_xyce_build_preflight_r11.py

m01-open-source-device-dc-r01-contract-check:
	"$(PYTHON)" scripts/check_m01_open_source_device_dc_r01_contract.py

m01-open-source-device-dc-r01:
	"$(PYTHON)" scripts/run_m01_open_source_device_dc_r01.py

m01-open-source-device-dc-r01-check:
	"$(PYTHON)" scripts/check_m01_open_source_device_dc_r01.py

m01-open-source-device-dc-r02-contract-check:
	"$(PYTHON)" scripts/check_m01_open_source_device_dc_r02_contract.py

m01-open-source-device-dc-r02:
	"$(PYTHON)" scripts/run_m01_open_source_device_dc_r02.py
...
m01-route-divergence-r01:
	"$(PYTHON)" scripts/run_m01_route_divergence_root_cause_r01.py

m01-route-divergence-r01-check:
	"$(PYTHON)" scripts/check_m01_route_divergence_root_cause_r01.py

m01-route-divergence-r02-contract-check:
	"$(PYTHON)" scripts/check_m01_route_divergence_root_cause_r02_contract.py

m01-route-divergence-r02:
	"$(PYTHON)" scripts/run_m01_route_divergence_root_cause_r02.py

m01-route-divergence-r02-check:
	"$(PYTHON)" scripts/check_m01_route_divergence_root_cause_r02.py

c00-active-load-inverter-r01-contract-check:
	"$(PYTHON)" scripts/check_c00_active_load_inverter_r01_contract.py

c00-active-load-inverter-r01:
	"$(PYTHON)" scripts/run_c00_active_load_inverter_r01.py

c00-active-load-inverter-r01-check:
	"$(PYTHON)" scripts/check_c00_active_load_inverter_r01.py

c00-active-load-inverter-r02-contract-check:
	"$(PYTHON)" scripts/check_c00_active_load_inverter_r02_contract.py

c00-active-load-inverter-r02:
	"$(PYTHON)" scripts/run_c00_active_load_inverter_r02.py

c00-active-load-inverter-r02-check:
	"$(PYTHON)" scripts/check_c00_active_load_inverter_r02.py

c00-active-load-inverter-r03-contract-check:
	"$(PYTHON)" scripts/check_c00_active_load_inverter_r03_contract.py

c00-active-load-inverter-r03:
	"$(PYTHON)" scripts/run_c00_active_load_inverter_r03.py
